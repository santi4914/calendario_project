...
class CalendarioView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        next_month = current_date_obj + timedelta(
            days=32
        )  # Suma 32 para asegurar el salto al siguiente mes

        context["month_days"] = (
            month_days  # Lista de semanas, cada una con una lista de objetos date
        )
...
class NotaCreateView(CreateView):
    ...
    def get_success_url(self):
        ...
        return reverse_lazy(
            ...
            kwargs={"year": nota.fecha.year, "month": nota.fecha.month},
        )
